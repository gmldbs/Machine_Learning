...
from DNN import ClassifierModel, FCLayer, SoftmaxLayer, ReLU, Sigmoid, Tanh
...
model.add_layer('FC-0', FCLayer(784, 512))
model.add_layer('Tanh1', Tanh())
model.add_layer('FC-1', FCLayer(512, 256))
model.add_layer('Tanh1', Tanh())
model.add_layer('FC-2', FCLayer(256, 128))
model.add_layer('Tanh2', Tanh())
model.add_layer('FC-3', FCLayer(128, 64))
model.add_layer('Tanh3', Tanh())
model.add_layer('FC-4', FCLayer(64, 32))
model.add_layer('Tanh3', Tanh())
model.add_layer('FC-5', FCLayer(32, 16))
model.add_layer('Tanh3', Tanh())
model.add_layer('FC-6', FCLayer(16, 10))
model.add_layer('Softmax Layer', SoftmaxLayer())
